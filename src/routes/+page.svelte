<script lang="ts">
  ...
  $: recommendedKey =
    userPlatform && release?.platforms[userPlatform]
      ? userPlatform
  ...
  function checkElementVisibility() {
    ...
    floatingElements.forEach((element, index) => {
      ...
      const elementVisible =
        rect.top < innerHeight * 0.8 && rect.bottom > innerHeight * 0.2;
  ...
  function handlePrimaryDownload() {
    if (recommendedKey && release?.platforms[recommendedKey]) {
      window.open(
        release.platforms[recommendedKey].url,
        "_blank",
        "noopener,noreferrer",
      );
    }
  ...
  onMount(() => {
    ...
    if (mqSupported) {
      ...
      if (typeof _reducedMotionMQ.addEventListener === "function") {
        _reducedMotionMQ.addEventListener(
          "change",
          _reducedMotionHandler as EventListener,
        );
      ...
      try {
        if (_reducedMotionHandler) {
          if (typeof _reducedMotionMQ.removeEventListener === "function") {
            _reducedMotionMQ.removeEventListener(
              "change",
              _reducedMotionHandler as EventListener,
            );
...
<div class="page-root">
    ...
    <div class="hero-content">
      <div class="hero-left">
        ...
        <p class="hero-subtitle">
          A lightweight, reliable Minecraft launcher designed to make launching
          and managing your game effortless.
        </p>
          ...
          {:else if release}
            <div class="smart-download">
              <button
                ...
                on:click={handlePrimaryDownload}
              >
                <span class="download-icon"
                  >{recommendedKey?.includes("windows")
                    ? "🪟"
                    : recommendedKey?.includes("darwin")
                      ? "🍎"
                      : "🐧"}</span
                >
                <span class="download-text">
                  Download for {recommendedKey
                    ? labelFor(recommendedKey)
                    : "Your Platform"}
                </span>
              </button>
              <div
      ...
      <div class="hero-right">
        <div
          class="hero-image floating-element"
          bind:this={floatingElements[0]}
        >
  ...
  <section class="features-section">
    <div class="features-grid">
      <div
        class="feature-card floating-element"
        bind:this={floatingElements[1]}
      >
        <div class="feature-icon">🌐</div>
        <h3>Cross-Platform</h3>
        <p>
          Native support for Windows, macOS (Intel & Apple Silicon), and Linux
          distributions.
        </p>
      </div>
      ...
      <div
        class="feature-card floating-element"
        bind:this={floatingElements[2]}
      >
        <div class="feature-icon">🔒</div>
        <h3>Secure & Verified</h3>
        <p>
          All releases are cryptographically signed and verified through
      ...
      <div
        class="feature-card floating-element"
        bind:this={floatingElements[3]}
      >
        <div class="feature-icon">⚡</div>
        <h3>Lightning Fast</h3>
        <p>
          Minimal resource footprint with instant startup and responsive
          interface.
        </p>
      </div>
      ...
      <div
        class="feature-card floating-element"
        bind:this={floatingElements[4]}
      >
        <div class="feature-icon">🔓</div>
        <h3>Open Source</h3>
        <p>
          Fully transparent codebase available on GitHub for inspection and
          contribution.
        </p>
      </div>
    </div>
  ...
  <section class="showcase-section">
      ...
      <div class="showcase-content">
        <div class="showcase-text">
          ...
          <p>
            ...
            Everything you need is just a click away - from selecting your
            favorite version to jumping straight into your world.
          </p>
        ...
        <div class="showcase-image">
          <enhanced:img
            src={homeImage}
            alt="Kable Launcher Home Interface"
            loading="lazy"
          />
        </div>
      </div>
    ...
    <!-- Mod Management -->
    <div
      class="showcase-item floating-element reverse"
      bind:this={floatingElements[6]}
    >
      <div class="showcase-content">
        <div class="showcase-text">
          <h3>Powerful Mod Management</h3>
          <p>
            Take control of your Minecraft experience with our comprehensive mod
            management system. Install, update, and organize your mods
            effortlessly.
          </p>
          <ul class="feature-list">
        ...
        <div class="showcase-image">
          <enhanced:img
            src={manageModsImage}
            alt="Kable Launcher Mod Management"
            loading="lazy"
          />
        </div>
      </div>
    ...
    <div class="showcase-item floating-element" bind:this={floatingElements[7]}>
      <div class="showcase-content">
        <div class="showcase-text">
          ...
          <p>
            Find your next favorite mod with our integrated search and discovery
            system. Browse thousands of mods with detailed information and user
            reviews.
          </p>
          <ul class="feature-list">
    ...
    <div
      class="showcase-item floating-element reverse"
      bind:this={floatingElements[8]}
    >
      <div class="showcase-content">
        <div class="showcase-text">
          <h3>Flexible Configuration</h3>
          <p>
            Customize Kable to work exactly how you want. From memory allocation
            to mod loader preferences, every aspect is configurable.
          </p>
          <ul class="feature-list">
    ...
    <div class="showcase-item floating-element" bind:this={floatingElements[9]}>
      <div class="showcase-content">
        <div class="showcase-text">
          ...
          <p>
            When things go wrong, Kable has your back. Our comprehensive logging
            system helps you troubleshoot issues quickly and efficiently.
          </p>
          <ul class="feature-list">
  ...
  <section id="about" class="about-section">
    <div
      class="about-content floating-element"
      bind:this={floatingElements[10]}
    >
      <h2 class="section-title gradient-primary-tertiary">Who are "we"?</h2>
      <div class="about-text">
        <p>
          Actually, it's just me! I'm <strong>Luuk Kablan</strong> (LuckyLuuk_),
          a passionate developer working on Kable Launcher in my spare time.
        </p>
        <p>
          I started this project because I wanted a simple, reliable way to
          launch Minecraft without the bloat of existing launchers. What began
          as a personal tool has grown into something I hope others will find
          useful too.
        </p>
        <p>
          When I'm not coding Kable, I work on various other projects and enjoy
          exploring new technologies. I believe in open source software and the
  ...
  <footer class="site-footer">
    <div class="footer-content">
      ...
      <a
        href="https://github.com/LuckyLuuk12/kable"
        class="footer-link gradient-primary-tertiary"
      >
        View on GitHub
      </a>
    </div>
